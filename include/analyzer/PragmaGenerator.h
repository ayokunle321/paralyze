...
struct GeneratedPragma
{
  ...
  GeneratedPragma(PragmaType t, const std::string& text, const std::string& ltype, unsigned line,
...
public:
  ...
  const std::vector<GeneratedPragma>& getGeneratedPragmas() const { return generated_pragmas_; }
